...
all: asio-1.12.2 chat_server Dealer Player Make_a_play 
...
chat_server: src/Dealer.o src/Player.o src/Make_a_play.o
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(LDLIBS) src/chat_server.cpp src/Dealer.o src/Player.o src/Make_a_play.o -o chat_server

#chat_client: temporarily disabled in place of interface
#	$(CXX) $(CXXFLAGS) $(CPPFLAGS) src/chat_client.cpp $(LDLIBS) -c -o chat_client

Dealer: src/Dealer.cpp
...
#src/test-dealer: src/BOOST_dealer.cpp src/Dealer.cpp
#	${CXX} -o $@ $^ -Wall -std=c++11

src/test-MAP: src/BOOST_make_a_play.cpp src/Player.cpp src/Make_a_play.cpp 
	${CXX} -o $@ $^ -Wall -std=c++11

src/test-player: src/BOOST_player.cpp src/Dealer.cpp src/Player.cpp 
	${CXX} -o $@ $^ -Wall -std=c++11
